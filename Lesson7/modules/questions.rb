...
module Questions
  ...
  def ask_for_new_wagon_number
    puts 'QUESTION: Enter new wagon\'s number:'
    gets.chomp
  end

  def ask_for_new_wagon_capacity
    puts 'QUESTION: Setup wagon\'s capacity (volume or amount of seats):'
    gets.chomp.to_i
  end
